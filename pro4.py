...
def drowsiness_monitor(frame, flag):
    ...
    for subject in subjects:
        ...
        if ear < thresh:
            ...
            if flag >= frame_check:
                cv2.putText(frame, "********Drowssness ALERT!********", (10, 400),
...
while True:
    ...
    et4=dt.now()
    cv2.imshow('Head Pose + Drowseness + Eye Tracking + Face points', frame4)
    ...
    print("Total elapsed time: "+str(et4-st))
