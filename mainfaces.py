        ...
        if ret == True:
            ...
            for face in faces:
                ...
                if left_eye_ratio < blink_threshold and right_eye_ratio < blink_threshold:
                    cv2.putText(frame, "Both Eye Blinking and sleeping", (10, 100), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
                elif left_eye_ratio < blink_threshold:
                    cv2.putText(frame, "Left Eye Blinking", (10, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
                elif right_eye_ratio < blink_threshold:
                    cv2.putText(frame, "Right Eye Blinking", (10, 70), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
                else:
                    cv2.putText(frame, "Active", (10, 130), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
            
            
            if len(faces) >1 :
                cv2.putText(frame, "Number of Detected Faces " + str(len(faces)), (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
            elif len(faces)==1:
                cv2.putText(frame, "Number of Detected Faces " + str(len(faces)), (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
